...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$description = encryptthis($_POST['description'],$key);
										...
										<tbody>
											...
											?>
												<tr>
													...
													$key='qkwjdiw239&&jdafweihbrhnan&^%$ggdnawhd4njshjwuuO';
													$encryption_key = base64_decode($key);
													list($encrypted_data, $iv) = array_pad(explode('::', base64_decode($row['categoryDescription']), 2),2,null);
													$row['categoryDescription'] = openssl_decrypt($encrypted_data, 'aes-256-cbc', $encryption_key, 0, $iv);
																																			
													echo htmlentities($row['categoryDescription']); ?></td>
